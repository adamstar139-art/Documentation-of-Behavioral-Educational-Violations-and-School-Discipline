...
def get_connection():
    """الاتصال بقاعدة بيانات Supabase الدائمة (PostgreSQL)"""
    conn = psycopg2.connect(st.secrets["supabase"]["conn_str"])
    conn.autocommit = True
    return _ConnWrapper(conn)

def read_sql(sql, con, params=None):
    """بديل متوافق لـ pd.read_sql_query يعمل مع PostgreSQL بنفس صياغة الكود"""
    cur = con.cursor()
...
def init_db():
    ...
    default_students = [
        ...
        ('2344500760', 'سعيد محمد - باوزير', 'الصف الثاني المتوسط', 'فصل 3', '966553435135'),
...
PROCEDURES_BY_DEGREE = {
    ...
    "الدرجة الثانية (المخالفات متوسطة الشدة)": [
        "تعهد و تنبيه شفهياً بعدم التكرار",
